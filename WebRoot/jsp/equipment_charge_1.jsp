...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" id="row_1" >
      <tr>
        <td class="left_bt3"><b>当前位置：器材管理&gt;&gt;更新收费标准</b></td>
      </tr>
      <tr>
        ...
        <td height="20%">&nbsp;</td>   <!-- 设置right 内容 高度 -->
          ...
          <tr>
            ...
            <form name="form1" method="post" action="equipment_charge.jsp">
...
<table id="rounded-corner">
    <thead>
    	<tr>
            ...
            <th scope="col" class="rounded">&nbsp;</th>
            <th scope="col" class="rounded">请更新费用信息</th>
            <th scope="col" class="rounded">&nbsp;</th>
            <th scope="col" class="rounded">&nbsp;</th>
            <th scope="col" class="rounded">&nbsp;</th>
     ...
     <tbody>
        ...
        <td colspan="1">损坏费用：</td>
         <td><input name="shfy" type="text">&nbsp;*</td>        
        <td>&nbsp;</td>
        <td>&nbsp;</td>
		<td>&nbsp;</td>
        <td>&nbsp;</td>
	    ...
	    <td>&nbsp;</td>
	    <td>&nbsp;</td>
	    <td colspan="1">租用费用：</td>
	    <td><input name="qcfy" type="text">&nbsp;*</td>       
	    <td>&nbsp;</td>        
	    <td>&nbsp;</td>
	    <td>&nbsp;</td>
	    <td>&nbsp;</td>
	    ...
	    <tr>
	        <td>&nbsp;</td>
	       	<td>&nbsp;</td>
	        <td>&nbsp;</td>
	        <td><input name="Save" type="submit" class="btn_an" value="保存">&nbsp;<input name="Reset" type="reset" class="btn_an" value="重置"></td>      
	        <td>&nbsp;</td>        
	        <td>&nbsp;</td>
	        <td>&nbsp;</td>
	        <td>&nbsp;</td>
