...
function check(form2){
	var checked=true;
    var id= document.getElementsByName("delGame");
    var checkCount = 0;
    ...
    if(checkCount == 0) {  
        ...
        if (confirm("您确定要删除这"+checkCount+"个赛事吗？"))
	       form2.action="../servlet/GameDel";
	       return false; 
    } 
}
</script>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" id="row_1" >
      <tr>
        <td class="left_bt3"><b>当前位置：赛事管理&gt;&gt;删除赛事</b></td>
      </tr>
      <tr>
    ...
    <thead>
     ...
     <tfoot>
    	<tr>
        	...
        	<input name="Save" type="submit" class="btn_red" value="删除赛事" onClick="check(form2)">
        	</td>
        </tr>
        <tr>
    ...
    <tbody>
    	<c:if test="${FindGame!=null}" var="flag" scope="page">
        	<c:forEach var="item" items="${FindGame}" varStatus="status">
            	<tr>
            		<td><input type="checkbox" name="delGame" value="${status.index}" /></td>
