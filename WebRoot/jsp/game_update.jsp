...
function check(form2){
	var checked=true;
    var id= document.getElementsByName("GameUpate");
    var checkCount = 0;
    ...
    if(checkCount == 0) {  
        ...
        form2.action="../servlet/GameUpdateTran";
        return false;  
    } 
}
</script>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" id="row_1" >
      <tr>
        <td class="left_bt3"><b>当前位置：赛事管理&gt;&gt;更新赛事</b></td>
      </tr>
      <tr>
    ...
    <thead>
     ...
     <tfoot>
    	<tr>
        	...
        	<input name="Save" type="submit" class="btn_blue" value="更新赛事" onClick="check(form2)">
        	</td>
        </tr>
    ...
    <tbody>
    	<c:if test="${FindGame!=null}" var="flag" scope="page">
        	<c:forEach var="item" items="${FindGame}" varStatus="status">
            	<tr>
            		<td><input type="checkbox" name="GameUpate" value="${status.index}" /></td>
