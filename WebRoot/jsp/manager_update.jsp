...
function check(form2){
	var checked=true;
    var id= document.getElementsByName("adminUpdate");
    var checkCount = 0;
    ...
    if(checkCount == 0) {  
        ...
        form2.action="../servlet/AdminUpdateTran";
        return false;  
    } 
}
</script>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" id="row_1" >
      <tr>
        <td class="left_bt3"><b>当前位置：人员管理&gt;&gt;更新管理员</b></td>
      </tr>
      <tr>
    ...
    <thead>
     ...
     <tfoot>
    	<tr>
        	...
        	<input name="Save" type="submit" class="btn_blue" value="更新管理员" onClick="check(form2)">
        	</td>
        </tr>
        <tr>
    ...
    <tbody>
    	...
    	<c:if test="${selectAdmin!=null}" var="flag" scope="page">
    		<c:forEach var="select" items="${selectAdmin}"  varStatus="status">
            	<tr>
            		<td> <input type="checkbox" name="adminUpdate" value="${status.index}" /></td>
