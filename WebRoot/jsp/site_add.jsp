...
function check(form1){
	...
	if(form1.cdms.value==""){
	   ...
	   form1.action="../servlet/SpaceAddServlet";
	}
}
</script>
   ...
   <form name="form1" method="post">
    ...
    <thead>
    	<tr>
            ...
            <th scope="col" class="rounded">&nbsp;</th>
            <th scope="col" class="rounded">请输入新场地信息</th>
            <th scope="col" class="rounded">&nbsp;</th>
            <th scope="col" class="rounded">&nbsp;</th>
            <th scope="col" class="rounded">&nbsp;</th>
     ...
     <tbody>
	    ...
	    <td><input name="cdsf" type="text">&nbsp;元/时*</td>       
	    <td>&nbsp;</td>        
	    <td>&nbsp;</td>
	    <td>&nbsp;</td>
	    <td>&nbsp;</td>
	    ...
	    <tr>
	        ...
	        <td colspan="1">场地描述：</td>
	         <td><input name="cdms" type="text">&nbsp;*</td>       
	        <td>&nbsp;</td>        
	        <td>&nbsp;</td>
	        <td>&nbsp;</td>
	        <td>&nbsp;</td>
...
<table id="rounded-corner">
    ...
    <tbody>
        <c:forEach var="ShowSpace" items="${ShowSpace}">
          	<tr>
          		<td>&nbsp;</td>
