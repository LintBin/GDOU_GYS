...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" id="row_1" >
      <tr>
        <td class="left_bt3"><b>当前位置：场地管理&gt;&gt;更新收费标准</b></td>
      </tr>
      <tr>
        ...
        <td height="20%">&nbsp;</td>   <!-- 设置right 内容 高度 -->
          ...
          <tr>
            ...
            <form name="form1" method="post" action="../servlet/SpaceRentFeeUpdate">
...
<table id="rounded-corner">
    <thead>
    	<tr>
            ...
            <th scope="col" class="rounded">&nbsp;</th>
            <th scope="col" class="rounded">请更新收费标准</th>
            <th scope="col" class="rounded">&nbsp;</th>
            <th scope="col" class="rounded">&nbsp;</th>
            <th scope="col" class="rounded">&nbsp;</th>
     ...
     <tbody>
	    ...
	    <td><input name="cdsf" type="text" value="510￥">元/时*</td>       
	    <td>&nbsp;</td>        
	    <td>&nbsp;</td>
	    <td>&nbsp;</td>
	    <td>&nbsp;</td>
