...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2">
      <tr>
        <td height="31"><div class="titlebt">公告界面</div></td>
      </tr>
    </table></td>
  ...
  <tr>
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" id="row_1" >
      <tr>
        <td class="left_bt3"><b>当前位置：场地管理&gt;&gt;场地公告</b></td>
      </tr>
      <tr>
        ...
        <td height="20%">&nbsp;</td>   <!-- 设置right 内容 高度 -->
          ...
          <tr>
            ...
            <form name="form1" method="post" action="../servlet/SpaceNotice">
...
<table id="rounded-corner">
    <thead>
    	<tr>
            ...
            <th scope="col" class="rounded">&nbsp;</th>
            <th align="center" scope="col" class="rounded">请输入公告信息</th>
            <th scope="col" class="rounded">&nbsp;</th>
            <th scope="col" class="rounded">&nbsp;</th>
            <th scope="col" class="rounded">&nbsp;</th>
    ...
    <tbody>
        ...
        <td>&nbsp;</td>
       	<td>&nbsp;</td>
        <td colspan="1">标题：</td>
         <td><input name="ggbt" type="text" value="停用公告"></td>       
        <td>&nbsp;</td>        
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        ...
        <td>&nbsp;</td>
       	<td>&nbsp;</td>
        <td colspan="1">正文：</td>
         <td><textarea name="ggzw" rows="20" cols="100%">篮球场-01暂时停止使用</textarea></td>
        <td>&nbsp;</td>        
        <td>&nbsp;</td>        
        <td>&nbsp;</td>
        <td>&nbsp;</td>
