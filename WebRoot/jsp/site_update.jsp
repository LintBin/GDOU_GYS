...
function check(form2){
	var checked=true;
    var id= document.getElementsByName("ChangeSpace");
    var checkCount = 0;
    ...
    if(checkCount == 0) {  
        ...
        form2.action="../servlet/SpaceUpdateTran";
        return false;  
    } 
}
</script>
    ...
    <thead>
     ...
     <tfoot>
    	<tr>
        	...
        	<input name="Save" type="submit" class="btn_blue" value="更新场地" onClick="check(form2)">
        </tr>
        <tr>
    ...
    <tbody>
    	...
    	<c:if test="${FindSpace!=null}" var="flag" scope="page" >
    		 <c:forEach var="ShowSpace" items="${FindShowSpace}" varStatus="status">
          	<tr>
          		<td><input type="checkbox" name="ChangeSpace" value="${status.index}" /></td>
